cmake . -GNinja -Bbuild \
-DCMAKE_TOOLCHAIN_FILE=$HOME/workdir/buildscripts/emscripten/emsdk-portable/upstream/emscripten/cmake/Modules/Platform/Emscripten.cmake \
-DCMAKE_FIND_ROOT_PATH_MODE_LIBRARY=BOTH \
-DCMAKE_FIND_ROOT_PATH_MODE_INCLUDE=BOTH \
-DCMAKE_FIND_ROOT_PATH_MODE_PACKAGE=BOTH \
-DCMAKE_CXX_COMPILER_LAUNCHER=ccache \
-DCMAKE_PREFIX_PATH=$HOME/workdir/buildscripts/emscripten \
...
-DPLAYER_JS_OUTPUT_NAME=ynoengine-simd \
